...
namespace daxa
{
    static inline auto default_format_score(Format format) -> daxa_i32
    {
        switch (format)
        {
    ...
    struct SwapchainInfo
    {
        ...
        daxa_u32 width = 0;
        daxa_u32 height = 0;
        std::function<daxa_i32(Format)> surface_format_selector = default_format_score;
        ...
        daxa_usize max_allowed_frames_in_flight = 2;
    ...
    struct Swapchain : ManagedPtr
    {
        ...
        auto get_cpu_timeline_value() -> daxa_usize;
