...
namespace daxa
{
    ...
    struct ShaderCompileOptions
    {
        ...
        std::optional<daxa_u32> opt_level = {};
    ...
    struct DepthTestInfo
    {
        ...
        daxa_f32 min_depth_bounds = 0.0f;
        daxa_f32 max_depth_bounds = 1.0f;
    };
    ...
    struct RasterizerInfo
    {
        ...
        daxa_f32 depth_bias_constant_factor = 0.0f;
        daxa_f32 depth_bias_clamp = 0.0f;
        daxa_f32 depth_bias_slope_factor = 0.0f;
        daxa_f32 line_width = 1.0f;
    };
